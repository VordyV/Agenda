...
public static class Settings
{
    public static List<Module> Modules = new List<Module>()
    {
        new Module(
            ...
            title: "Simple",
            version: "0.1",
            view: (vm) => new SimpleModule.SimpleView() {DataContext = vm},
            viewModel: (conn) => new SimpleModule.SimpleViewModel(conn),
            fields: 
            [
            ...
            driver: () => new SimpleModule.SimpleDriver()
        ),
        new Module(
            id: "rconbf2142default",
            title: "Rcon BF2142 Default",
            version: "0.1",
            view: (vm) => new RconBF2142DefaultModule.View(),
            viewModel: (conn) => new SimpleModule.SimpleViewModel(conn),
            fields: 
            [
                new ModuleField(id: "address", title: "Address", control: () => new IPv4FieldControl(), required: true, validator: (data) => new ModuleFieldValidator(length: 15).Validate(data)),
